...
public class ChunkyLinesAbstractV2 extends Sketch {
    ...
    public static void main(String... args) {
        PApplet.main("drawings.ChunkyLinesAbstractV2");
    }
    ...
    public void sketch() {
        _colours.getColours().forEach((name, colour) -> {
            ...
            noStroke();
            fill(c1);
            drawAttractorPaths(attractorPointsLeft);
            fill(c2);
            drawAttractorPaths(attractorPointsTop);
            fill(c3);
            drawAttractorPaths(attractorPointsBottom);
            fill(c4);
            drawAttractorPaths(attractorPointsRight);
            save("chunky-lines-abstract-v2", name);
        });
    }

    private void drawAttractorPaths(ArrayList<AttractorPoint> attractorPoints) {
        try {
