...
public class InfernalMachines extends Sketch {
    ...
    private void squiggleGroup(Colours colour) {
        ...
        float phaseXA = random(260, 360);
        float amplitudeXA = random(260, 360);
        float dampingXA = random(0.0005f, 0.01f);

        float frequencyXB = random(0.05f, 1);
        float phaseXB = random(260, 360);
        float amplitudeXB = random(260, 360);
        float dampingXB = random(0.0005f, 0.01f);

        float frequencyYA = random(0.05f, 1);
        float phaseYA = random(260, 360);
        float amplitudeYA = random(260, 360);
        float dampingYA = random(0.0005f, 0.01f);

        float frequencyYB = random(0.05f, 1);
        float phaseYB = random(260, 360);
        float amplitudeYB = random(260, 360);
