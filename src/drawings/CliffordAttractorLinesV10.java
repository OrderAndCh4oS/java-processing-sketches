...
public class CliffordAttractorLinesV10 extends Sketch {
    ...
    public static void main(String... args) {
        PApplet.main("drawings.CliffordAttractorLinesV10");
    }
    ...
    public void sketch() {
        _colours.getColours().forEach((name, colour) -> {
            ...
            int bg = colour.black();
            background(bg);
            drawLineTextureWithGapsThick(colour.white(), 9, 6, Direction.TOP);
            fill(colour.black());
            stroke(colour.white());
            strokeCap(MITER);
            float margin = 200;
            ...
            save("clifford-attractor-lines-v10", name);
        });
    }
