...
public class EllipseMathV10 extends Sketch {
    public static void main(String... args) {
        PApplet.main("drawings.EllipseMathV10");
    }
    ...
    public void sketch() {
        _colours.getColours().forEach((name, colour) -> {
            blendMode(NORMAL);
            int c1 = colour.blackOrWhite();
            int c2;
            do {
                c2 = colour.blackOrWhite();
            } while (c1 == c2);
            background(c1);
