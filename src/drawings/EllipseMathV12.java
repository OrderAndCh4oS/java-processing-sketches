...
public class EllipseMathV12 extends Sketch {
    public static void main(String... args) {
        PApplet.main("drawings.EllipseMathV12");
    }
    ...
    public void sketch() {
        for (int iter = 0; iter < 10; iter++) {
            _colours.getColours("orange-v3", "constructivist-v2").forEach((name, colour) -> {
                blendMode(NORMAL);
                int c1 = colour.black();
                int c2;
                do {
