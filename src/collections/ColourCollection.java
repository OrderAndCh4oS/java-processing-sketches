...
public class ColourCollection {
    ...
    public ColourCollection() {
        ...
        _colours.put("constructivist", new Colours(0xff010D00, 0xffF2E0C9, 0xffF21905, 0xffBF0404, 0xffF2E1AC, 0xff590202));
        _colours.put("lemon", new Colours(0xff010326, 0xffF2E205, 0xffD9D6B0, 0xffA6A48A, 0xffF2CB05));
        ...
        _colours.put("contructivist-real", new Colours(0xffE8E5D7, 0xffFF4100,  0xff16130C));
        _colours.put("blizzard", new Colours(0xffBBE3F9, 0xffB6EEFC,  0xffE9FFFF, 0xffC3F5FF, 0xffEBF6F5));
    }
